...
- Only list attack paths which can be executed, no need to list attack paths which cannot be executed.

CRITICAL RULES for permissions analysis:
- Never infer permissions that are not explicitly listed as allowed
